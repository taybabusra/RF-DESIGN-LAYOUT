...
Q: What is transmission line? why it is necessary and important in RF system.

# Transmission line:
The transfer of energy from one point to another takes place through either waveguides or transmission lines.
Transmission line is a guided medium.
1.
2.The electrical lines which are used to transmit the electrical waves along them are called transmission lines.
3. Transmission lines are assumed to consist of a pair of wires which are uniform throughout their whole length.
4. Transmission lines are a means of conveying power from one point to another.

## Comparision between transmission line and waveguides:
- Transmission line: It's always consists of at least two separate conductors between whicha a coltage can exist.\
- Waveguides: It involve only one conductor. example: a hollow rectangular or circular waveguide within which the wave propagates.

Q: The difference between transmission line and waveguide I am not clear on that part.
